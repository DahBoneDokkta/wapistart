...
namespace AppWebApi.Controllers
{
    ...
    public class csCountryController : Controller
    {
        private ILogger<csCountryController> _logger = null;
        ...
        [ProducesResponseType(200, Type = typeof(List<ICountry>))]
        [ProducesResponseType(400, Type = typeof(string))]
        public async Task<IActionResult> AfricanAnimals(string count = "10")
        {
            try
            {
                ...
                List<ICountry> countries = await _service.AfricanAnimals(_count);
